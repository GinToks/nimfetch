...
**Быстрый и красивый инструмент для отображения системной информации**
...
| `dracula` | Фиолетово-циановая тема Dracula |
| `nord` | Холодная скандинавская тема |
| `gruvbox` | Тёплая ретро-тема |
| `catppuccin` | Нежная пастельная тема |
| `tokyonight` | Тёмная тема в стиле Tokyo Night |
| `onedark` | Тема Atom One Dark |
| `solarized` | Классическая Solarized |
| `monokai` | Яркая тема Monokai |
| `github` | Тема в стиле GitHub |
...
```toml
# nimfetch configuration file

[display]
# Список включённых модулей
enabled_modules = ["os", "kernel", "uptime", "packages", "cpu", "memory", "disk", "shell"]

# Разделитель между меткой и значением
separator = ": "

[logo]
# Тип логотипа: "auto", "arch", "ubuntu", "fedora", "debian", "none"
type = "auto"
